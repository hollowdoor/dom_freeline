...
rollup.rollup({
    ...
    b.then(what=>{
        ...
        try{
            var result = UglifyJS.minify('dist/dom-freeline.js');
            //console.log('result ',result)
            writeFile('dist/dom-freeline.min.js', result.code, onErrorCB('minify'));
        }catch(e){
