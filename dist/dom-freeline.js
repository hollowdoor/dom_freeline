...
function toSpaceCase(string) {
  return index$7(string).replace(/[\W_]+(.|$)/g, function (matches, match) {
    return match ? ' ' + match : ''
  }).trim()
}
...
function toCamelCase(string) {
  return index$5(string).replace(/\s(\w)/g, function (matches, letter) {
...
function style (element, property, value) {
  ...
  if (camel) {
    ...
    element.style[camel] = index$9(camel, value);
  }
}
...
function detect (cssProp) {
  var camel = index$3(cssProp);
  var result = index$1(camel);
...
DOMFreeLine.prototype.css = function css (styles){
    setCss(this, styles);
    return this;
};
...
//# sourceMappingURL=dom-freeline.js.map
